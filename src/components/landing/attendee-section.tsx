...
export default function AttendeeSection() {
  return (
    <section className="relative py-28 bg-gradient-to-br from-[#dbeafe] overflow-hidden">

      {/* Animated Background Elements - More subtle */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[20%] right-[5%] w-[400px] h-[400px] rounded-full bg-blue-100/30 blur-[140px]" />
        <div className="absolute bottom-[20%] left-[5%] w-[350px] h-[350px] rounded-full bg-blue-100/20 blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 flex justify-center order-2 lg:order-1">
          ...
          >
            <div className="relative bg-gradient-to-br from-zinc-950 via-slate-900 to-zinc-950 text-white rounded-[32px] p-6 border border-white/10 shadow-2xl shadow-blue-950/40 overflow-hidden">
              
              {/* Animated gradient border glow */}
              <div className="absolute inset-0 rounded-[32px] p-[1px] bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-pink-500/30 opacity-50" />
              
              {/* Background glow */}
              <div className="absolute -top-[30%] -left-[30%] w-72 h-72 bg-gradient-to-r from-blue-500/20 to-purple-500/20 blur-[100px] animate-pulse" />
              <div className="absolute -bottom-[30%] -right-[30%] w-72 h-72 bg-gradient-to-l from-blue-500/20 to-blue-500/20 blur-[100px] animate-pulse delay-1000" />
              ...
              <div className="flex justify-between items-center border-b border-white/5 pb-4 relative">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
              ...
              <div className="mt-5 relative">
                <p className="text-[10px] text-blue-300/60 uppercase tracking-widest font-bold flex items-center gap-1.5">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center order-1 lg:order-2">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 border border-blue-200 bg-white text-blue-700 font-bold uppercase tracking-wider text-[11px] w-fit mb-5"
          >
          ...
          <motion.p
            ...
            className="text-zinc-600 text-base md:text-lg font-normal mt-4 leading-relaxed"
          >
          ...
          >
            {STEPS.map((step, idx) => {
              ...
              return (
                <div key={idx} className="group flex gap-4 items-start p-4  border border-zinc-200 hover:border-blue-200 transition-all duration-200">
                  <div className={`flex items-center justify-center w-11 h-11 bg-blue-200 shadow-lg shrink-0 rounded-full`}>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-semibold text-zinc-400 bg-zinc-100 px-1.5 py-0.5">
                        0{idx + 1}
                      </span>
                    </div>
                    <p className="text-sm text-zinc-500 font-normal mt-0.5 leading-relaxed">
                      {step.desc}
                    </p>
                  </div>
                </div>
